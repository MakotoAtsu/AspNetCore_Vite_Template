...
3. Support HTTPS
4. Auto build and publish frontend app when publish backend app
...
1. Install this extension in your VS2019 or VS2022 (download from web or use VS extension manager)
3. Create new project and choose 1 template
...
4. Press F5 to run both backend server and frontend server
...
5. Hit button to fetch data from backend
...
6. Frontend app will auto build when you publish backend app
...
Just create a new vite template and replace all content in ClientApp folder
